...
<table width="828" align="center" cellpadding="0" cellspacing="0" border="0">
	<tr>
		...
		<div style="text-align:center; padding-bottom:5px;">
			<input class="li_btn" type="button" name="add" value="ADD NEW DEVICE" onClick="javascript:document.location='index.php?do=device'">
		</div>
			...
			<table class="dtable" align="center" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<input class="li_btn" type="button" value="edit" onClick="javascript:document.location='index.php?do=device&action=update&did=<?php echo $device['dID']; ?>'">
					<input class="li_btn" type="button" value="delete" onClick="javascript:document.location='index.php?do=device&action=delete&did=<?php echo $device['dID']; ?>'">
					</td>
				</tr>
				<tr>
